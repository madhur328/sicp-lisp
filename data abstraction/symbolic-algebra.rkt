...
(define (rational->complex n)
  (make-complex-from-real-imag (* 1.0 (/ (numer n) 
                                         (denom n)))
                               0))
...
; (define p1 (make-polynomial 'x '((2 1) (1 4) (0 6))))
; (define p2 (make-polynomial 'x '((3 4) (2 9) (0 6))))
; (define p3 (negate p2))
; (add p1 p2)
; (sub p2 p2)
; (mul p1 p2)
; (define p4 (make-polynomial 'x '((5 1) (0 -1))))
